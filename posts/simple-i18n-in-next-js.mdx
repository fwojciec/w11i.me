...
excerpt: 'A DIY approach to i18n in Next.js without heavy frameworks. Covers locale subpaths, automatic language detection, preference persistence, and context-based translations using dynamic routing.'
